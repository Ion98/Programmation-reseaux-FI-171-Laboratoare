...
public class ClientHttp
{
    ...
    HttpHost target;
    HttpHost proxy = new HttpHost("206.189.80.102", 3128);
    ...
    ClientHttp(String url, int port)
    {
        ...
        credsProvider.setCredentials(
                new AuthScope("206.189.80.102", 3128),
    ...
    public void loginAndPrintFriends() throws IOException, InterruptedException
    {
            ...
            HttpRequest request = HttpRequest.newBuilder()
                    .uri(URI.create("https://" + target.getHostName()+ "/ion.guidea.98/friends"))
            ...
            PrintWriter printWriter = new PrintWriter(new FileWriter("D:\\Anul3Semestrul2\\ion.txt"));
    ...
    private void printFriends() throws IOException
    {
        ...
        BufferedReader r = new BufferedReader(new FileReader("D:\\Anul3Semestrul2\\ion.txt"));
